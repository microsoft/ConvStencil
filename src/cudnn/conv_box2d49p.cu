...
int main() {
    ...
    filter_data_h = (double*)malloc(1 * 1 * 7 * 7 * sizeof(double));
    ...
    double *filter_data;
    cudaMalloc(&filter_data, 1 * 1 * 7 * 7 * sizeof(double));
    cudaMemcpy(filter_data, filter_data_h, 1 * 1 * 7 * 7 * sizeof(double), cudaMemcpyHostToDevice);
